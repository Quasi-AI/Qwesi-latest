...
const Newsletter = () => {
    return (
        <div className='flex flex-col items-center mx-4 my-36'>
            ...
            <div className='flex bg-white text-sm p-1 rounded-full w-full max-w-xl my-10  border-[#5C3AEB] shadow-sm'>
                <input 
                    className='flex-1 pl-5 outline-none text-gray-700 placeholder-gray-400' 
                    type="email" 
                    placeholder='Enter your email address' 
                />
                <button className='font-medium bg-[#5C3AEB] text-white px-7 py-3 rounded-full hover:bg-[#342299] hover:scale-103 active:scale-95 transition'>
                    Get Updates
                </button>
            </div>
